...
SECRET_KEY = 'django-insecure-*i1ya0@6zn6_3**p#wf5f&q937fg54#iop^b4sb=ll#g)g#03t'
...
# Allow credentials (cookies) if needed. For JWT this is not strictly required,
# but keep it True if you might use sessions.
